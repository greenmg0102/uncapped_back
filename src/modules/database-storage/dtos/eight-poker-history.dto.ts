...
export class EightPokerHistoryDto {
  @IsNotEmpty()
  ...
  @IsNotEmpty()
  summary: { shows: { player: string, cards: { rank: string, suit: string }[] }[], collected: { player: string, amount: string }[], mucks: string[], notShow: { player: string }[] };
